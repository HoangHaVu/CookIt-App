...
const RANKINGS = [
  {
    rank: 4,
    name: 'David Chen',
    recipeName: 'Spicy BBQ Wings',
    points: '1,540',
    imageSrc: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBHRyYMAnHXl9eNDfdWROix7-2byvqcrE1D4oiW9MPffGu_aGYjgPoq8obQGsg4o-BL_qznEDMNNu9JIOXRmO1xT0hRM-SZlB8H_Rjv_4jRf5KJoOPCkThKy0mod1uHzNqfw9t4n1j6grF4G1El_jrlRfeXZgqNr5E4VPqzyL6bV1K7tEj7s1No2iOuMzzAZJxJb2RF3iM7aW34Hq9KgPvIABosIay3RBJQp0WRHnxplCu-bfA725Nv6HBUDt8-ZZt5ao6oq-6KdkeY',
  },
  {
    rank: 5,
    name: 'Maria Garcia',
    recipeName: 'Grilled Peach Salad',
    points: '1,420',
    imageSrc: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAvmfIOlQDF8O_XENkfDeGS5i66QmTYdO3CwvSQJJS-FLrSyZIUu94xUmY9RviixeWAjglYf2yr7TArKdLSZgynFP2vbb4_xrrRsrZabpUGGTdQ0mPs8ZZT3_ooodnV9Y3iOJxjGakvU4yC-HNgBvaYan0tNTKP7FjmPbtxRNa4vNIBniWpe8j_GeKHUd52defFhS7CPSiPdLGX76Pd9ZdkPLB5XCkK_n0HvyBM6RBxdNOFmO7YClieo5k3ge11jbu6S_tZErJ8OFCe',
  },
  {
    rank: 6,
    name: 'James Wilson',
    recipeName: 'Smoked Brisket',
    points: '1,210',
    imageSrc: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCRXBcj1VhPi6iztOyYT-CntPqhOrV2oBt3JE3DEzq4xpBcII2c6Aeo8tVdZS6Q4xfK19-2NTYApfYWjXTFvdlHfIbW2y0Qn2hxRCJtdCGBq_4Y-ubp-uhi6DlnWk4W_W-UlyG7hlNAeZ-U7enZSDQb-HnDLJtOJ561L0PbKuTaGYT6hX1DHX8nJ5dYzE6DNX8zjG9oaNx4QzUqSyo0irUbv-aHNfcEPJQ8LBzlYlHaB09gM-6hq4fz527eJQEkFees6l2TgiV9vZXS',
  }
];
    ...
    <div className="max-w-md mx-auto bg-background-light dark:bg-background-dark min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      <div className="px-4 py-2">
        <div className="flex bg-slate-100 dark:bg-slate-800/50 p-1 rounded-xl mt-4 border border-slate-200 dark:border-slate-800">
          <button className="flex-1 py-2.5 text-sm font-bold rounded-lg bg-white dark:bg-slate-800 shadow-sm text-primary transition-all">
            Recipes
          </button>
          <button className="flex-1 py-2.5 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-slate-700 transition-colors">
            Creators
          </button>
        </div>
      </div>
