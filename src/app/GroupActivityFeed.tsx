          ...
          <div className="flex gap-8 border-b border-white/10">
            {FEED_TABS.map((tab) => (
              <button
                ...
                className={`flex flex-col items-center justify-center border-b-4 pb-4 pt-2 transition-all uppercase tracking-[0.2em] text-[10px] font-black ${
                  activeTab === tab
      ...
      <main className="flex-1 px-6 pt-10 space-y-12 pb-48">
        ...
        {activeTab === 'Recipes' && (
          <EmptyState
            ...
            subtitle="Members haven't shared any recipes to this circle yet"
          />
        )}
        ...
        {activeTab === 'Members' && (
          <EmptyState
            icon="groups"
            title="Members"
            subtitle="Invite members to start cooking together"
            actionLabel="Invite Members"
            onAction={() => navigate('/invitemembers')}
          />
        )}
      </main>
